...
*馃摎 Total commands : 137*
*馃獉 Owner* : @${configs.ownerList[0].split('@')[0]}
*馃枈锔� Prefix* : Multi
*鈴� Time* : ${moment().utcOffset('1000').format('YYYY-MM-DD HH:mm:ss')} WIB
*馃拰 Rest API's* : https://zeks.me
...
Jangan lupa Follow IG: instagram.com/raghib.13
